...
/**
 * Demo-Programm #2
 * Trainiert ein neues KNN, gibt den Trainings-Erfolg aus und speichert das KNN gegebenenfalls
...
{
    /**
     * Erstellt ein Referenznetz
     * ACHTUNG: Das KNN wird nicht gespeichert
     * @param args ignored
     */
    public static void main (String[] args)
    {
        System.out.println(execute(new int[]{200}, null, 0.02, 0.01, 37000, 5000, 20).toString());
    }
     ...
     */
    public static NeuralNet.NeuralNetTrainingResult execute(int[] layers, String path, double tolerance, double learning_rate, int train_size, int test_size, int iterations)
    {
